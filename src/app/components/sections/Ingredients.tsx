      ...
      <div className={styles.container}>
        <div className={`${styles.head} reveal`}>
          ...
          <h2 className={styles.title}>
            La puissance de la <em>nature</em>
          </h2>
        </div>
        ...
        <div className={`${styles.feature} reveal`}>
          <div className={styles.featureVisual}>
            <Image
              src="/cactus.png"
              alt="Figuier de barbarie"
              width={260}
              height={300}
              className={styles.featureCactus}
            />
            <svg className={styles.ring} viewBox="0 0 400 400">
              ...
              >
                <textPath href="#ingCircle">
                  GEL DE CACTUS · OPUNTIA FICUS-INDICA · ALGÉRIE ·
                </textPath>
              </text>
            </svg>
          </div>
          ...
          <div className={styles.featureInfo}>
            ...
            <p className={styles.fText}>
              ...
              de chaque formule Cactuvia. Le figuier de barbarie porte une
              grande importance: c&apos;est un symbole de résilience,
              d&apos;attachement à la terre et de générosité.
            </p>
            <div className={styles.benefits}>
              {[
                "Hydratation & nutrition profonde",
                "Cicatrisant & régénérant",
                "Riche en antioxydants",
                "Soutient le microbiome cutané",
              ].map((b, i) => (
        ...
        <div className={styles.grid}>
          {ingredients.map((ing, i) => (
            <div
              className={`${styles.ingCard} reveal reveal-d${i + 1}`}
              key={i}
            >
